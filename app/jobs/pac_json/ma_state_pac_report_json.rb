...
module PacJSON
  class MAStatePacReportJSON
    ...
    def initialize(report, campaign, users, committee)
      ...
      @data = Hash.new
      @data['ma'] = Hash.new
      @data['ma']['state'] = Hash.new
      @data['ma']['state'][@report.report_type] = Hash.new
      @data['ma']['state'][@report.report_type]['textfield'] = Hash.new
    ...
    private
    def data_main
      data['ma']['state'][@report.report_type]
    end
    ...
    def generate_committee
      ...
      data_main['textfield']['txtCommZip[0]'] = @committee.zipcode
    ...
    def generate_chair
      ...
      data_main['textfield']['txtChairEmail[0]'] = chair['email']
    ...
    def generate_treasurer
      ...
      data_main['textfield']['txtChairEmail[1]'] = treasurer['email']
      data_main['textfield']['txtChairPhone[1]'] = treasurer['phoneNumber']
    end
